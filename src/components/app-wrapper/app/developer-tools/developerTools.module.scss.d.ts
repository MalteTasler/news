declare const styles: {
    developerTools__cbShowMore: string | undefined;
    developerTools__selectBackend__selectButton: any;
    developerTools__selectBackend: string | undefined;
    developerTools__idDisplay__copiedLabel: string | undefined;
