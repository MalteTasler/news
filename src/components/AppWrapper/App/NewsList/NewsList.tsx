...
const NewsList = ({siteId, tappId, news, now, onPut, onPatch, onDelete, frontendURL}) =>
    <div id = "news_list">
        {
            news.map((element: { id: React.Key | null | undefined; publishTime: string; headline: string | null | undefined; message: string; imageList: (string | null | undefined)[] | null | undefined; publishTimestamp: number; hidden: boolean }) =>
            {
                if(!element)
                    return "no content"
                return (
