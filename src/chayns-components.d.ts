...
declare module 'chayns-components' {
    import React, { CSSProperties, FunctionComponent, MouseEvent, MutableRefObject, ReactElement, ReactNode } from 'react';
    ...
    export const TextString: React.FunctionComponent<TextStringProps> & {
      getTextString: (stringName: string, language?: string, fallback?: string) => string;
      loadLibrary: (projectName: string, middle?: string, language?: string) => Promise<void>;
    };
    ...
    export const ComboBox: <T extends unknown>(props: ComboBoxProps<T>) => ReturnType<FunctionComponent<ComboBoxProps<T>>>;
    ...
    type FileInputProps = BaseComponentProps & {
      ...
      items?: Array<{
        ...
        style?: CSSProperties;
        disabled?: boolean;
        content?: { text: string; icon?: string } | { children: ReactElement | Array<ReactElement> };
      }>;
    };
    ...
    type ContextMenuProps = BaseComponentProps & {
      ...
      items?: Array<{ className?: string; onClick?: () => void | Promise<void>; text: string | ReactElement; stringName?: string; icon: string }>;
      position?: number;
  ...
  declare module 'chayns-components/lib/utils/selectFile' {
      ...
      export default function selectFile(options: SelectFileOptions): Promise<File | null>;
  }
  
  declare module 'chayns-components/lib/utils/compressImage' {
      const compressImage: (file: File, maxFileSize: number, quality?: number) => Promise<File>;
