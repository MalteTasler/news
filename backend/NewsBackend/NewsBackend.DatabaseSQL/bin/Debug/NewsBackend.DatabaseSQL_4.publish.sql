...
GO
PRINT N'Fremdschlüssel "unbenannte Einschränkungen auf [dbo].[Image]" wird erstellt...';


GO
ALTER TABLE [dbo].[Image] WITH NOCHECK
    ADD FOREIGN KEY ([NewsEntryId]) REFERENCES [dbo].[NewsEntries] ([Id]);
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Image'))
               AND [type] IN (N'F', N'C')
